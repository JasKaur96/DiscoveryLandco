...
class About extends Component{
    ...
    render(){
        return(<>   
          ...
          <div className="p" style={{ "textAlign": "center", "fontSize": "35px", "fontStyle": "oblique", padding: "210px" }}>
            ...
            <div className="inner-content">
              ...
              <div className="space"></div>
                <div className="father-image">
                  <img src="https://dxaurk9yhilm4.cloudfront.net/images/163/What_we_do_intro_5ae402c9837860cd6e4f65e304b3a5fa.jpg"  alt=""/>      
                </div>
              </div> 
            </div>
            <div className="ship-container">
              <div className="ships">
               <img data-lazy-src="https://dxaurk9yhilm4.cloudfront.net/images/696/Bakers_Carousel3_62018727b9e8103a3d5d6c0701991eca.jpg" alt="" src="https://dxaurk9yhilm4.cloudfront.net/images/696/Bakers_Carousel3_62018727b9e8103a3d5d6c0701991eca.jpg" style={{"opacity": "1", "width":"1700px","height":"900px"}}/>
              </div>
            </div>
            <div className="father-main">
              <div className="inner-content">
          ...
          <div className="ship-container">
            <div className="ships">
            <img data-lazy-src="https://dxaurk9yhilm4.cloudfront.net/images/159/What_we_do_design_hero_62018727b9e8103a3d5d6c0701991eca.jpg" alt="" data-parallax="{&quot;scale&quot;: &quot;[1, 1.25]&quot;}" data-parallax-mobile=""style={{"opacity": "1", "width":"1890px","height":"900px","will-change": "transform"}} src="https://dxaurk9yhilm4.cloudfront.net/images/159/What_we_do_design_hero_62018727b9e8103a3d5d6c0701991eca.jpg"/>
          </div>
          </div><br></br><br></br>
          <div className="ship-container">
            <div className="ships">
            <img  src="https://dxaurk9yhilm4.cloudfront.net/images/160/What_we_do_footer_2_5dabbd1a34149dcaed83515ff1526a0f.jpg"style={{ "width":"1890px","height":"660px","will-change": "transform", "opacity": "1"}} alt=""/>
            </div>
          </div>
